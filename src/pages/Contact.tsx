...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      details: ["info@alqalam.edu", "admissions@alqalam.edu"]
    },
    {
      icon: <MapPin className="h-6 w-6" />,
      title: "Location",
      details: ["123 Islamic Center St.", "New York, NY 10001"]
    },
    {
      ...
      <section className="py-20 calligraphy-overlay">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with us for any inquiries about our programs or to start your journey with Al Qalam Institute
          </p>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 transition flex items-center justify-center"
                  >
